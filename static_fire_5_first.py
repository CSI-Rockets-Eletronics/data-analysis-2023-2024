...
start = datetime(year=2024, month=4, day=19, hour=12, minute=15)
...
fs["thermo1C"] = fs["thermo1C"].rolling(window=10).median()
fs["thermo2C"] = fs["thermo2C"].rolling(window=10).median()
